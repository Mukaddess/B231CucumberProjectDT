...
public class BlueRentalStepDefinition {
 ...
 public void kullaniciBleuRentalCarSayfasinaGider() {
 ...
 @And("kullanici {string} ve {string} bilgileri girer")
 public void kullaniciVeBilgileriGirer(String email, String password) {
 ...
 String path ="src/test/resources/adminTestData.xlsx";
  ...
  for (int i = 1 ;i <=excelUtils.rowCount(); i++) {//rowCount uzerine gel bekle ne isi yaradigini gor
